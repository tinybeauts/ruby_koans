...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Inject takes a starting point [inject(starting point, default = 0)]
    # then it performs an operation on each element of an array, each
    # time updating the current value of the starting point
  end
